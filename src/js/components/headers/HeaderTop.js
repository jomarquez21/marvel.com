    ...
    <div class="header__top">
      <div class="header__top__container">
        <div class="header__top__signin">
          <span class="header__top__signin__logo icon--svg--white-fill">
        ...
        <div class="header__top__main-logo">
        ...
        <div class="header__top__card">
          <a href="#" class="mastercard">
            <span class="mastercard__icon"></span>
            <div class="mastercard__description">
              <span>MARVEL</span>
        ...
        <div class="header__top__search">
          <a href="#" class="search-icon-link">
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="17" viewBox="0 0 19 17" fill-rule="evenodd">
